...
const fixture = {
  dossier: { id: "d1", organizationId: "o1", dossierCode: "APF-01", title: "Cadastro", countingType: "impact", status: "draft", totalImpactedPf: 0, totalHomologatedPf: null, countingSessionId: "s1", updatedAt: "2026-08-17", userStory: { code: "HU-1", title: "Cadastrar" } },
