...
export default function QualityCoveragePage() {
  ...
  return <main className="mx-auto w-full max-w-[1500px] space-y-5 px-4 pb-8 pt-5 md:px-8 md:pt-6"><QualitySectionHeader icon={GitBranch} title="Cobertura" count={rows.length} />
