...
export default function QualityCoveragePage() {
  ...
  return <main className="mx-auto w-full max-w-[1500px] space-y-5 px-4 pb-8 pt-5 md:px-8 md:pt-6"><header className="border-b pb-5"><p className="mb-1.5 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-primary"><GitBranch className="h-4 w-4" /> Matriz viva</p><h1 className="text-2xl font-bold leading-tight tracking-tight md:text-3xl">Cobertura e rastreabilidade</h1><p className="mt-1 text-sm text-muted-foreground">Encontre lacunas entre requisito, caso versionado, planejamento e resultado executado.</p></header>
