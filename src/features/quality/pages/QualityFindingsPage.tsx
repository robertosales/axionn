...
export default function QualityFindingsPage() {
  ...
  return <main className="mx-auto w-full max-w-[1500px] space-y-6 p-4 md:p-8">
    <header className="border-b pb-6"><p className="mb-2 flex items-center gap-2 text-sm font-medium text-primary"><Bug className="h-4 w-4" /> Risco rastreável</p><h1 className="text-3xl font-bold tracking-tight">Achados de qualidade</h1><p className="mt-1 text-sm text-muted-foreground">Transforme resultados inesperados em um fluxo auditável de triagem e resolução.</p></header>
