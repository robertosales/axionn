...
export default function QualityOverviewPage() {
  ...
  return <main className="mx-auto w-full max-w-[1500px] space-y-6 px-4 pb-8 pt-5 md:px-8 md:pt-6"><header className="grid gap-4 border-b pb-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end"><div><p className="text-xs font-semibold uppercase tracking-[0.14em] text-primary">Quality Intelligence</p><h1 className="mt-2 max-w-4xl text-2xl font-bold leading-tight tracking-tight md:text-3xl">Controle a qualidade como um fluxo, não como uma planilha.</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">Da definição do caso à decisão sobre o risco, preserve contexto, evidência e responsabilidade.</p></div><Button asChild className="min-h-11"><Link to="/sala-agil/qualidade/cobertura">Ver cobertura<ArrowRight className="ml-2 h-4 w-4" /></Link></Button></header>
