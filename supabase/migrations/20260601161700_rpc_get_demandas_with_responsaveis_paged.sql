-- RPC paginada do backlog de sustentação.

CREATE OR REPLACE FUNCTION public.get_demandas_with_responsaveis_paged(
  p_team_id uuid,
...
COMMENT ON FUNCTION public.get_demandas_with_responsaveis_paged(
  uuid,
  timestamptz,
  integer
) IS
  'Lista demandas por time com cursor e responsáveis; exige acesso ao time e limita a 200 registros.';
