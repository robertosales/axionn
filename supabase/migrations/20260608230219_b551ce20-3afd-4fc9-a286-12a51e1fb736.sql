  ...
  FOREACH v_team_id IN ARRAY p_team_ids LOOP
    ...
    SELECT COALESCE(jsonb_agg(
      jsonb_build_object(
        ...
        -- SLA crítico — usa o motor canônico (contract_slas) quando disponível:
        --   resolution_pct >= 85% OU já estourado.
        -- Fallback (sem contract_id ou sem SLA configurado): prazo_solucao ≤ 24h ou estourado.
        'slaCriticalCount', (
