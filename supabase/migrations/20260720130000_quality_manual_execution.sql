...
language plpgsql security definer set search_path=public,pg_temp as $$ begin
 if not public.can_manage_quality(p_org_id) then raise exception using errcode='42501',message='quality_run_start_denied'; end if;
...
begin
 if not public.can_manage_quality(p_org_id) then raise exception using errcode='42501',message='quality_result_update_denied'; end if;
...
begin
 if not public.can_manage_quality(p_org_id) then raise exception using errcode='42501',message='quality_evidence_create_denied'; end if;
...
language plpgsql security definer set search_path=public,pg_temp as $$ begin
 if not public.can_manage_quality(p_org_id) then raise exception using errcode='42501',message='quality_run_complete_denied'; end if;
...
language plpgsql security definer set search_path=public,pg_temp as $$ begin
 if not public.can_manage_quality(p_org_id) then raise exception using errcode='42501',message='quality_run_reopen_denied'; end if;
