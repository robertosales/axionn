-- EXECUCAO COMPLEMENTAR FINAL DE 70 REGISTROS ORFAOS.

begin;

do $explicit_confirmation$
declare
  confirmation constant text := 'DELETE_70_ORPHAN_PERSONAL_ROWS_FROM_AXIONN_TEST_2026_07_13';
begin
  if confirmation <> 'DELETE_70_ORPHAN_PERSONAL_ROWS_FROM_AXIONN_TEST_2026_07_13' then
    raise exception 'ABORT: confirmacao explicita ausente ou invalida';
  end if;
